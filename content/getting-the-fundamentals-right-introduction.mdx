...
general knowledge of programming, but right now, I'll be focusing on the
fundamentals of front-end development: HTML, CSS and JavaScript. My goal here is
to create a guide that I wish I had when I started learning web development.
